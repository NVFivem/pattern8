...
5. When the download is done, open the file.
6. If Windows shows a security prompt, choose the option that lets you continue.
7. Follow the on-screen steps to finish the install or launch the app.
...
1. Place it in the project you want to manage.
2. Open the app or the setup file if one is provided.
3. Choose the rules you want your AI agent to follow.
4. Connect it to the tool you use, such as a coding assistant or local agent setup.
5. Save the settings.
6. Test it with a small task first.
...
- `pattern8/` for the app or config
- `rules/` for your agent rules
- `projects/` for work files
- `logs/` for records of agent actions
...
5. Check that your rules still load the way you expect.
